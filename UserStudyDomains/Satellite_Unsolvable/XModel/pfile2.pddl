...
(:goal (and
	...
	(done-take_image satellite planet1 instrument1 infrared)
	(done-take_image satellite planet2 instrument1 infrared)
	(done-take_image satellite phenomenon1 instrument1 visible)
	(done-take_image satellite phenomenon2 instrument1 infrared)
	(done-take_image satellite star2 instrument1 infrared)
))
